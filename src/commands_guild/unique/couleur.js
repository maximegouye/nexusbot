...
module.exports = {
  data: new SlashCommandBuilder()
    ...
    .addSubcommand(s => s.setName('rgb').setDescription('🎨 Analyser une couleur RGB')
      .addIntegerOption(o => o.setName('rouge').setDescription('Rouge 0-255').setRequired(true).setMinValue(0).setMaxValue(255))
      .addIntegerOption(o => o.setName('vert').setDescription('Vert 0-255').setRequired(true).setMinValue(0).setMaxValue(255))
      .addIntegerOption(o => o.setName('bleu').setDescription('Bleu 0-255').setRequired(true).setMinValue(0).setMaxValue(255)))
