...
const SEGMENTS = [
  ...
  { label: '×2 GAIN',      mult: 2,     emoji: '📈', color: '#F39C12', type: 'win' },
  { label: '×3 MISE',      mult: 3,     emoji: '💰', color: '#2ECC71', type: 'win' },
  { label: '×5 BOOST',     mult: 5,     emoji: '⚡', color: '#F1C40F', type: 'win' },
  { label: '×8 SUPER',     mult: 8,     emoji: '🔥', color: '#E67E22', type: 'win' },
  { label: '×15 MEGA',     mult: 15,    emoji: '💎', color: '#9B59B6', type: 'mega' },
  { label: '×30 ULTRA',    mult: 30,    emoji: '👑', color: '#E74C3C', type: 'ultra' },
  { label: 'JACKPOT ×100', mult: 100,   emoji: '🌟', color: '#FFD700', type: 'jackpot' },
