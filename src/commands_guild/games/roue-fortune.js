...
const SEGMENTS = [
  ...
  { label: '×1.2 GAIN',    mult: 1.2,   emoji: '📈', color: '#F39C12', type: 'win' },
  { label: '×1.5 MISE',    mult: 1.5,   emoji: '💰', color: '#2ECC71', type: 'win' },
  { label: '×2 BOOST',     mult: 2,     emoji: '⚡', color: '#F1C40F', type: 'win' },
  ...
  { label: 'JACKPOT ×25',  mult: 25,    emoji: '🌟', color: '#FFD700', type: 'jackpot' },
