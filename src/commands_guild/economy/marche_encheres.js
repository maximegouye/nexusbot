...
module.exports = {
  data: new SlashCommandBuilder()
    ...
    .addSubcommand(s => s.setName('vendre')
      ...
      .addIntegerOption(o => o.setName('duree').setDescription('Durée en minutes (5-720)').setRequired(true).setMinValue(5).setMaxValue(720))
      .addStringOption(o => o.setName('description').setDescription('Description de l\'objet').setMaxLength(300))
      .addIntegerOption(o => o.setName('achat_immediat').setDescription('Prix d\'achat immédiat (optionnel)').setMinValue(10)))
    .addSubcommand(s => s.setName('miser')
      ...
      .addIntegerOption(o => o.setName('montant').setDescription('Votre enchère').setRequired(true).setMinValue(1)))
