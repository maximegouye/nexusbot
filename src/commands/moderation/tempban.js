...
module.exports = {
  ...
  async execute(interaction) {
    ...
    if (member && member.roles.highest.position >= interaction.member.roles.highest.position)
      return interaction.reply({ content: '❌ Tu ne peux pas bannir ce membre (rôle supérieur ou égal).', ephemeral: true });
    ...
    try {
      ...
      await interaction.reply({ content: `❌ Impossible de bannir ce membre : ${e.message}`, ephemeral: true });
    }
  }
};
