...
module.exports = {
  ...
  async execute(interaction) {
    ...
    if (warnId) {
      ...
      if (result.changes === 0) return interaction.editReply.bind(interaction)({ content: `❌ Warn #${warnId} introuvable pour ce membre.`, ephemeral: true });
      return interaction.editReply.bind(interaction)({ embeds: [new EmbedBuilder().setColor('#2ECC71').setDescription(`✅ Avertissement **#${warnId}** supprimé pour **${target.username}**.`)] });
    }
