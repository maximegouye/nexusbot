...
module.exports = {
  ...
  async execute(interaction) {
    ...
    if (warnId) {
      ...
      if (result.changes === 0) return interaction.reply({ content: `❌ Warn #${warnId} introuvable pour ce membre.`, ephemeral: true });
      return interaction.reply({ embeds: [new EmbedBuilder().setColor('#2ECC71').setDescription(`✅ Avertissement **#${warnId}** supprimé pour **${target.username}**.`)] });
    }
