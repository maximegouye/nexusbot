  ...
  async execute(interaction) {
    ...
    if (sub === 'canal_ajouter') {
      ...
      try {
        ...
        return interaction.reply({ content: '❌ Ce canal est déjà configuré.', ephemeral: true });
      }
    }
    ...
    if (sub === 'canal_retirer') {
      ...
      if (result.changes === 0) {
        return interaction.reply({ content: '❌ Ce canal n\'est pas configuré.', ephemeral: true });
      }
    ...
    if (sub === 'role_ajouter') {
      ...
      try {
        ...
        return interaction.reply({ content: '❌ Ce rôle est déjà configuré.', ephemeral: true });
      }
    }
    ...
    if (sub === 'role_retirer') {
      ...
      if (result.changes === 0) {
        return interaction.reply({ content: '❌ Ce rôle n\'est pas configuré.', ephemeral: true });
      }
